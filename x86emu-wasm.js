...
function integrateWasmJS() {
    ...
    function getBinaryPromise() {
        if (!Module["wasmBinary"] && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && typeof fetch === "function") {
            return fetch("https://s3.amazonaws.com/production-assetsbucket-8ljvyr1xczmb/e9039441-905e-411f-9dea-c295c46e1a08/x86emu-wasm.wasm", {
    ...
    function doNativeWasm(global, env, providedBuffer) {
        ...
        if (!Module["wasmBinary"] && typeof WebAssembly.instantiateStreaming === "function" && !isDataURI(wasmBinaryFile) && typeof fetch === "function") {
            WebAssembly.instantiateStreaming(fetch("https://s3.amazonaws.com/production-assetsbucket-8ljvyr1xczmb/e9039441-905e-411f-9dea-c295c46e1a08/x86emu-wasm.wasm", {
                credentials: "same-origin"
...
function _emscripten_async_wget3_data(url, request, user, password, post_data, post_data_len, arg, free, onload, onerror, onprogress) {
    ...
    if (_url.includes("alpine-x86.cfg")) {
        _url = "https://s3.amazonaws.com/production-assetsbucket-8ljvyr1xczmb/e9039441-905e-411f-9dea-c295c46e1a08/alpine-x86.cfg"
    }

    if (_url.includes("kernel-x86.bin")) {
